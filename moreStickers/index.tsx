...
export default definePlugin({
    name: "MoreStickers+",
    description: "Adds sticker packs from other social media platforms (e.g., LINE). Maintained by BenjiThatFoxGuy.",
    authors: [{ name: "BenjiThatFoxGuy", id: 263241553072488448n }, EquicordDevs.Leko, Devs.Arjix],
    ...
    start() {
        startRemoteRefresh().catch(console.error);
    },
    stop() {
        stopRemoteRefresh();
    },
